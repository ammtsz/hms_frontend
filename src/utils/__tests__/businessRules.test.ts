...
describe("businessRules", () => {
  describe("sortPatientsByPriority", () => {
      ...
      const patients: TestPatient[] = [
        {
          name: "Patient C",
          priority: "3",
          checkedInTime: "2025-01-15T09:00:00Z",
        },
        {
          name: "Patient A",
          priority: "1",
          checkedInTime: "2025-01-15T10:00:00Z",
        },
        {
          name: "Patient B",
          priority: "2",
          checkedInTime: "2025-01-15T08:00:00Z",
        },
      ];
    ...
    it("should use check-in time as tiebreaker for same priority", () => {
      const patients: TestPatient[] = [
        ...
        },
        {
          name: "Patient C",
          priority: "1",
          checkedInTime: "2025-01-15T11:00:00Z",
        },
      ];
    ...
    it("should handle mixed priority and time scenarios", () => {
      const patients: TestPatient[] = [
        {
          name: "Priority 2 Late",
          priority: "2",
          checkedInTime: "2025-01-15T11:00:00Z",
        },
        {
          name: "Priority 1 Late",
          priority: "1",
          checkedInTime: "2025-01-15T10:30:00Z",
        },
        {
          name: "Priority 2 Early",
          priority: "2",
          checkedInTime: "2025-01-15T09:00:00Z",
        },
        {
          name: "Priority 1 Early",
          priority: "1",
          checkedInTime: "2025-01-15T09:30:00Z",
        },
        {
          name: "Priority 3",
          priority: "3",
  ...
  describe("isPatientAlreadyScheduledForAssessment", () => {
    const mockAppointmentsByDate: AppointmentByDate = {
      ...
      assessment: {
        scheduled: [
          { name: "John Smith", priority: "1" },
          { name: "Emily Williams", priority: "2" },
        ],
