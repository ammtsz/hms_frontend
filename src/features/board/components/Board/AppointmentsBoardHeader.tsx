...
import { useUnresolvedPastAppointments } from "@/api/query/hooks/useAppointmentQueries";
...
export const AppointmentsBoardHeader: React.FC<AppointmentsBoardHeaderProps> = ({
  selectedDate,
  onDateChange,
    ...
    <div className="w-full pb-4">
      ...
      <div className="mb-4 flex flex-col justify-between gap-3 md:flex-row md:items-center md:gap-16">
        ...
        <Button
          ...
          title="Check unresolved appointments from past dates"
        >
      ...
      {noSlotsForDay && !isDayFinalized && !isDayDisabledByHoliday ? (
        <div className="mb-4 flex items-center gap-2 rounded border border-amber-400 bg-amber-100 px-4 py-2 text-amber-800">
          <span className="text-lg">📋</span>
          <div>
            <strong>There is no appointment on this day</strong>
            <p className="text-sm">
          ...
          <div>
            ...
            {isDayDisabledByHoliday ? (
              <p className="mt-0.5 text-sm">
                It is not possible to manage appointments on this date. Select
                another date.
              </p>
            ) : null}
          </div>
