...
const UnresolvedPastAppointmentsModal: React.FC = () => {
  ...
  // Calculate totals
  const totalAppointments = dates.reduce((sum, d) => sum + d.count, 0);
      ...
      <div className="p-6">
        ...
        <div className="text-center mb-6">
          <p className="text-lg font-semibold text-gray-800 mb-2">
            {totalAppointments === 1
              ? "1 unresolved appointment"
              : `${totalAppointments} unresolved appointments`}
          </p>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6 max-h-96 overflow-y-auto">
          <p className="text-sm font-semibold text-gray-700 mb-3">
            Dates with pending appointments:
          </p>
...
export default UnresolvedPastAppointmentsModal;
