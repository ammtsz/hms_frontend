...
describe("AppointmentHistory Utils", () => {
  describe("getStatusConfig", () => {
    ...
    it("should return correct config for cancelled status", () => {
      ...
      expect(config.label).toBe(APPOINTMENT_HISTORY_STATUS_LABELS.cancelled);
    ...
    it("should return correct config for completed status", () => {
      ...
      expect(config.label).toBe(APPOINTMENT_HISTORY_STATUS_LABELS.completed);
  ...
  describe("getTreatmentTypeLabel", () => {
    it("should return Assessment Consultation when only assessment is true", () => {
      ...
      expect(label).toBe(getAppointmentTypeLabel("assessment"));
    });
    ...
    it("should return Assessment Consultation and Physiotherapy when assessment and physiotherapy", () => {
      ...
      expect(label).toBe(
        `${getAppointmentTypeLabel("assessment")} and ${getAppointmentTypeLabel("physiotherapy")}`,
      );
    });
    ...
    it("should return Assessment Consultation and TENS when assessment and tens", () => {
      ...
      expect(label).toBe(
        `${getAppointmentTypeLabel("assessment")} and ${getAppointmentTypeLabel("tens")}`,
      );
    });
    ...
    it("should return Assessment Consultation, Physiotherapy and TENS when all three treatments exist", () => {
      ...
      expect(label).toBe(
        `${getAppointmentTypeLabel("assessment")}, ${getAppointmentTypeLabel("physiotherapy")} and ${getAppointmentTypeLabel("tens")}`,
      );
    });
