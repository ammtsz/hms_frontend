...
/**
 * Displays absence information for missed or cancelled appointments
 * Shows appointment type, reason, and justification status
 * Updated to match ScheduledAppointmentsCard styling pattern
 */
