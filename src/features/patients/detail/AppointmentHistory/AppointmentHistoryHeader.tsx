...
interface AppointmentHistoryHeaderProps {
  totalItems: number;
  isCollapsed: boolean;
  loading: boolean;
...
/**
 * Header component for Appointment History Card
 * Displays title, count, refresh button, and collapse/expand toggle
 */
export const AppointmentHistoryHeader: React.FC<
  AppointmentHistoryHeaderProps
