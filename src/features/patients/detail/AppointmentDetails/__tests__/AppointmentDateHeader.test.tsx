...
describe("AppointmentDateHeader", () => {
  it("renders normal appointment date without icons", () => {
    render(
  ...
  it("renders cancelled appointment with Ban icon and label", () => {
  ...
  it("renders missed appointment with AlertTriangle icon and label", () => {
    const { container } = render(
      <AppointmentDateHeader
        date="2026-01-25"
        status="missed"
