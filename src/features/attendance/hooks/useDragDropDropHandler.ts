...
import { isNewPatientCheckInDataComplete } from '@/features/attendance/components/WalkIn/utils/newPatientCheckInValidation';
import type {
...
import { isAllowedDropTarget, isValidMove } from '@/features/attendance/utils/dragDropRules';
import {
  findPatientInBoard,
  updatePatientTimestamps,
} from '@/features/attendance/utils/dragDropAttendanceHelpers';
import { performAttendanceMove } from '@/features/attendance/utils/dragDropPerformMove';
