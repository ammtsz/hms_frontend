...
jest.mock("@/features/attendance/components/AttendanceActions/ManageAttendanceModal", () => {
  return {
    __esModule: true,
    default: () => (
...
jest.mock("@/features/attendance/components/Board/MultiSectionModal", () => {
  return {
    __esModule: true,
    default: () => (
...
jest.mock("@/features/attendance/components/Board/AssessmentBeforeTreatmentConfirmModal", () => {
  return {
    __esModule: true,
    default: () => (
...
jest.mock("@/features/attendance/components/WalkIn/NewPatientCheckInModal", () => {
  return {
    __esModule: true,
    default: () => (
...
jest.mock("@/features/attendance/components/Consultation/PostAttendanceModal", () => {
  return {
    __esModule: true,
    default: () => (
...
jest.mock("@/features/attendance/components/EndOfDay/EndOfDayModal", () => {
  return {
    __esModule: true,
...
jest.mock("@/features/attendance/components/TreatmentSession/PostTreatmentModal", () => {
  return {
    __esModule: true,
    default: () => (
...
jest.mock("@/features/attendance/components/Consultation/ViewCompletedConsultationModal", () => {
  return {
    __esModule: true,
    default: () => (
...
jest.mock("@/features/attendance/components/AttendanceActions/UnresolvedPastAttendancesModal", () => {
  return {
    __esModule: true,
    default: () => (
